                                    ...
                                    <li>
                                        ...
                                        <div className="mt-2 space-y-1">
                                            <div className="flex items-center">
                                                <span className="test__body--toggle-details-not-visit">0</span> You have not visited the question yet.
                                            </div>
                                            <div className="flex items-center">
                                                <span className="test__body--toggle-details-no-answered">-1</span> You have not answered the question.
                                            </div>
                                            <div className="flex items-center">
                                                <span className="test__body--toggle-details-answered">1</span> You have answered the question.
                                            </div>
                                            <div className="flex items-center">
                                                <span className="test__body--toggle-details-review">0</span> You have NOT answered the question but marked it for review.
                                            </div>
                                            <div className="flex items-center">
                                                <span className="test__body--toggle-details-answered-review">1</span> The question is Answered and Marked for Review and will be considered for evaluation.
                                            </div>
                                        </div>
                                    </li>
                                    <li>
